...
/*jslint 
 * white: true, browser: true, devel: true, windows: true, 
 * forin: true, onevar: true, undef: true, nomen: true, 
 * plusplus: true, regexp: true, newcap: true, immed: true 
 */
...
Webfm.debug = function (container, width, height) {
	...
	if (dbgButton) {
		...
		listener = Webfm.eventListenerAdd(Webfm.eventListeners, dbgButton, "click", function () {
																									cp.show();
																								});
	}
};
...
Webfm.debug.prototype.show = function () {
	...
	if (this.enable) {
		...
		listener = Webfm.eventListenerAdd(this.eventListeners, elClear, "click", function () {
																								cp.clear();
																							});
		...
		listener = Webfm.eventListenerAdd(this.eventListeners, elCache, "click", function (e) { 
																								cp.showCache(); 
																								Webfm.stopEvent(e);
																							});
...
Webfm.pane.prototype.resizeEnd = function (event) {
	...
	setTimeout(function () {
							window.scrollTo(0, Webfm.scrollVal);
						}, 1);
};
